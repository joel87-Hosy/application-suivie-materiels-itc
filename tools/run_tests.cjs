...
const EXCLUDED={
 'test_account_affiliations_browser.cjs':'Chrome headless requis (exécuté séparément)',
 'test_bon_signatures_browser.cjs':'Chrome headless + .tools/report-libs (non versionné)',
